...
public class NNModelController : MonoBehaviour
{
    public static NNModelController Instance;
    ...
    public Coroutine Detect(Color32[] picture, System.Action<List<BoundingBox>> callback)
    {
        return this.StartThrowingCoroutine(DetectRoutine(picture, callback));
    }
    IEnumerator DetectRoutine(Color32[] picture, System.Action<List<BoundingBox>> callback)
    {
    ...
    private List<BoundingBox> FilterBoundingBoxes(IList<BoundingBox> boxes, int limit, float threshold)
    {
